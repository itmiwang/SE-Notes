...
![image-20200504141407141](picture/持久层整合/image-20200504141407141.png)
...
功能：
	1. 自动扫描@Transactional注解作为切入点
	2. transaction-manager用于获取2中的额外功能
~~~
...
3. 只读属性 - readOnly
4. 超时属性 - timeout
5. 异常属性 - rollbackFor/noRollbackFors
~~~
